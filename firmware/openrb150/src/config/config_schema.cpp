...
void defaultRobotConfig(RobotConfig& cfg) {
  ...
  // Servo map. The array is indexed in (leg, joint) order and the DXL bus ids
  // follow the robot wiring leg-major: leg 1 = coxa 1 / femur 2 / tibia 3,
  // leg 2 = 4/5/6, ... leg 6 = 16/17/18, i.e. id = leg*kJointsPerLeg + joint
  // + 1. Conservative +/-90deg travel about 2048.
